    ...
    return (
        <div className='max-w-7xl m-auto mt-[112px]'>
            <h2 className='mb-10 font-semibold text-4xl leading-[124%] tracking-[-0.04em] '>Afzallik <br/>
    tomonlari</h2>
    <div className='grid grid-cols-2 items-center'>
    <div>
        <Image src={'/sec6.png'} width={535} height={610} alt='q'/>
    </div>
    <div className='grid grid-cols-1 items-center gap-[78px] justify-center'>
    ...
    <span className='w-[305px]'>
        <h2 className='mb-2 font-semibold'>100% kafolatlangan loyihani yakunlash</h2>
        <p>Birgalikda hisob qaydnomasi bilan loyihani boshqarish dasturi yordamida xavfsiz, qulay va shaffof bo`ling.</p>
    </span>
    ...
    <span className='w-[305px]'>
        <h2 className='mb-2 font-semibold'>Qo`shimcha to`lovlar olinmaydi</h2>
        <p>Yashirin xarajatlar yo`q. Siz olgan taklifning qiymati siz to`lagan qiymatdir.</p>
    </span>
    ...
    <span className='w-[305px]'>
        <h2 className='mb-2 font-semibold'>Jarayonni bevosita kuzating </h2>
        <p>Yashirin xarajatlar yo`q. Siz olgan taklifning qiymati siz to`lagan qiymatdir.</p>
    </span>

        </div>
            <button    onClick={() => setModal(true)} className="hidden md:inline-block bg-[#FD665E] text-white text-sm sm:text-base w-[190px] h-[56px]  rounded-[4px] hover:bg-[#e05550] transition">
            Bepul konsultatsiya
            </button>
    </div>
    </div>
